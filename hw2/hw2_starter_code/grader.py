...
def check_omniglot():
    ...
    """
    if not os.path.isdir("./submission/omniglot_resized"):
        gdd.download_file_from_google_drive(
            file_id="1iaSFXIYC3AB8q9K_M-oVMa4pmB7yKMtI",
            dest_path="./omniglot_resized.zip",
            unzip=True,
        )
    assert os.path.isdir("./submission/omniglot_resized"), "Omniglot dataset is not available! Run `python maml.py --cache` first to download the dataset!"
