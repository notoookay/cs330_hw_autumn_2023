...
class MAML:
    ...
    def _outer_step(self, task_batch, train):
        ...
        for task in task_batch:
            ...
            images_support = images_support.to(self.device) # (num_way * num_support, channels, height, width)
            labels_support = labels_support.to(self.device) # (num_way * num_support)
            images_query = images_query.to(self.device) # (num_way * num_query, channels, height, width)
            labels_query = labels_query.to(self.device) # (num_way * num_query)
            ### START CODE HERE ###
            # TODO: finish implementing this method.
            ...
            loss = F.cross_entropy(logits, labels_query) # (num_way * num_query)
