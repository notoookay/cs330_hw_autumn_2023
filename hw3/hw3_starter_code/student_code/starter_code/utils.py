...
def get_dataset(dataset: str, n_train: int, n_val: int = 100):
    if dataset == "cnn":
        ...
        # Note: the datatset is from https://github.com/seokjeongeum/cs330/blob/07036ffef895e804a474a4addada734a50d80a2b/hw3_starter_code/starter_code/data/amazon_reviews_us_Video_v1_00.csv
